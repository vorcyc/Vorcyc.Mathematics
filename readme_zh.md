...
**版本：** 0.10.1 · **目标框架：** `net10.0` · **NuGet：** `Vorcyc.Mathematics`
...
**计算上下文（ComputingContext）** — CPU 执行策略与 `ComputingScope`；已接入 FFT、统计、矩阵/向量、批 DL、MFCC 并行、Mel 音频前端及 `Trainer.Fit*`。  
...
| `wiki_hans/HOME_zh.md` | 简体中文 Wiki 首页（独立维护） |
| `docs/` | 许可证、Logo、文档索引 |
...
| **wiki_en/HOME.md** | 英文 Wiki 首页（NuGet 包 README 来源） |
