[根目录](https://github.com/vorcyc/Vorcyc.Mathematics/wiki) / [Root(en_us)](README-en_us)
...
* :ledger: [实验性模块](Module_Experimental)
  ...
  * :bookmark: [ITimeDomainCharacteristics 接口](Module_Experimental#itimedomaincharacteristics-接口)
  * :bookmark: [ITimeDomainSignal 接口](Module_Experimental#itimedomainsignal-接口)
  * :bookmark: [ISingleThreadTimeDomainSignal 接口](Module_Experimental#isinglethreadtimedomainsignal-接口)
  * :bookmark: [IModifiableTimeDomainSignal 接口](Module_Experimental#imodifiabletimedomainsignal-接口)
  * :bookmark: [IFrequencyDomainCharacteristics 接口](Module_Experimental#ifrequencydomaincharacteristics-接口)
  * :bookmark: [IFrequencyDomain 接口](Module_Experimental#ifrequencydomain-接口)
  * :bookmark: [FrequencyDomain 结构体](Module_Experimental#frequencydomain-结构体)
  * :bookmark: [Signal 类](Module_Experimental#signal-类)
  * :bookmark: [ModifiableTimeDomainSignal 类](Module_Experimental#modifiabletimedomainsignal-类)
  * :bookmark: [SignalSegment 结构体](Module_Experimental#signalsegment-结构体)
  * :bookmark: [SignalGeneratingExtension 类](Module_Experimental#signalgeneratingextension-类)
  * :bookmark: [CurveFitter&lt;T> 类](Module_Experimental#curvefittert-类)
  * :bookmark: [CurveFittingMethod 枚举](Module_Experimental#curvefittingmethod-枚举)
  * :bookmark: [FitResult&lt;T> 类](Module_Experimental#fitresultt-类)
  * :bookmark: [DataRow&lt;T> 结构体](Module_Experimental#datarowt-结构体)
  * :bookmark: [OptimizationMode 枚举](Module_Experimental#optimizationmode-枚举)
...
* :ledger: [FFTW 扩展](Module_Extensions_FFTW)
  * :bookmark: [Dft1D — 一维变换](Module_Extensions_FFTW#dft1d--一维变换)
  * :bookmark: [Dft2D — 二维变换](Module_Extensions_FFTW#dft2d--二维变换)
  * :bookmark: [Dft3D — 三维变换](Module_Extensions_FFTW#dft3d--三维变换)
  * :bookmark: [DftND — N 维变换](Module_Extensions_FFTW#dftnd--n-维变换)
  * :bookmark: [RealToRealTransforms](Module_Extensions_FFTW#realtorealtransforms--实数到实数变换单精度)
  * :bookmark: [HilbertTransform 类](Module_Extensions_FFTW#hilberttransform-类)
  * :bookmark: [EnvelopeComputer 类](Module_Extensions_FFTW#envelopecomputer-类)
  * :bookmark: [SignalExtension 类](Module_Extensions_FFTW#signalextension-类)
