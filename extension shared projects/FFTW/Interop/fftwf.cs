...

{
    ...
    [LibraryImport(LibraryName, EntryPoint = "fftwf_cleanup")]
    ...
    /// Exhaustive mode. 
    /// </remarks>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_set_timelimit")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_2d")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_3d")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_r2c_1d")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_r2c_2d")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_r2c_3d")]
    ...
    /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_r2c")]
    ...
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_c2r_1d")]
    ...
    /// <param name="output">Pointer to an array of 4-byte real numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_c2r_2d")]
    ...
    /// <param name="output">Pointer to an array of 4-byte real numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_c2r_3d")]
    ...
    /// <param name="output">Pointer to an array of 4-byte real numbers</param>
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_dft_c2r")]
    ...
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_r2r_1d")]
    ...
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_r2r_2d")]
    ...
    /// <param name="flags">Flags that specify the behavior of the planner</param>
    [LibraryImport(LibraryName, EntryPoint = "fftwf_plan_r2r_3d")]
    ...
    [LibraryImport(LibraryName, EntryPoint = "fftwf_flops")]
    ...
    [LibraryImport(LibraryName, EntryPoint = "fftwf_print_plan")]
    ...
    [LibraryImport(LibraryName, EntryPoint = "fftwf_export_wisdom_to_filename", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(LibraryName, EntryPoint = "fftwf_import_wisdom_from_filename", StringMarshalling = StringMarshalling.Utf8)]
    ...
    public static partial void fftwf_forget_wisdom();
}
