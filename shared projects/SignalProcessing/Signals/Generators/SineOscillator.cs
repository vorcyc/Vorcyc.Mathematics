...
/// <summary>
/// Sinusoidal oscillator with amplitude mapping to [<see cref="Min"/>, <see cref="Max"/>].
/// </summary>
public sealed class SineOscillator : IAmplitudeOscillator
{
    private int _n;
    ...
    {
        var sample = MathF.Sin(2 * ConstantsFp32.PI * Frequency / SamplingRate * _n + Phase);
