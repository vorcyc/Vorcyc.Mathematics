...
public readonly struct SignalSegment : ITimeDomainSignal, ISingleThreadTimeDomainSignal
{
    ...
    public FrequencyDomain TransformToFrequencyDomain(ComputingContext? context = null, WindowType? window = null)
    {
        if (window is null && _length.IsPowerOf2())
        {
            ...
            FastFourierTransform.Forward(Samples, result, context);
        ...
        return new FrequencyDomain(_start, windowedSamples.Length, _length, resultPadded, this, window);
    }
