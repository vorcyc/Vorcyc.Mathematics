...
using Vorcyc.Mathematics.SignalProcessing.Transforms.Wavelets;
...
namespace Vorcyc.Mathematics.SignalProcessing.FeatureExtractors
{
    ...
    public class WaveletExtractor : FeatureExtractor
    {
        ...
        {
            _blockSize = options.FwtSize > FrameSize ? options.FwtSize : FrameSize.NextPowerOf2();
            ...
            _fwt = new Fwt(_blockSize, new Transforms.Wavelets.Wavelet(_waveletName));
