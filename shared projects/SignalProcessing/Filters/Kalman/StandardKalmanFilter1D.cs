namespace Vorcyc.Mathematics.SignalProcessing.Filters.Kalman;
...
/// </code>
/// </remarks>
//[Filter(design: FilterDesignMethod.StandardKalman, structure: .Kalman, description: "一维标准卡尔曼滤波器")]
public class StandardKalmanFilter1D<T>
