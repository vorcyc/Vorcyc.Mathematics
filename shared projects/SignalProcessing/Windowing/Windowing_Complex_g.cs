...
public partial class Windowing
{
  ...
  */
    ...
    public static void Rectangular<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    { }

    public static unsafe void Rectangular<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    { }
    ...
    public static unsafe void Triangular<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Triangular<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    /// <param name="pData"></param>
    /// <param name="length"></param>
    public static unsafe void Hamming<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Hamming<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T const_0p54 = T.CreateTruncating(0.54);
        T const_0p46 = T.CreateTruncating(0.46);
    ...
    /// <param name="pData"></param>
    /// <param name="length"></param>
    public static unsafe void Blackman<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Blackman<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Hann<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static unsafe void Hann<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T zero_point_five = T.CreateTruncating(0.5);
    ...
    public static void Gaussian<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T zero_point_five = T.CreateTruncating(0.5);
    ...
    public static unsafe void Gaussian<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T zero_point_five = T.CreateTruncating(0.5);
        T factor = T.CreateTruncating(length - 1) * zero_point_five;
    ...
    public static void Kaiser<T>(Complex<T>[] data, int offset, int length, T? alpha = null)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    /// <param name="length"></param>
    /// <param name="alpha">The default value is 12</param>
    public static unsafe void Kaiser<T>(Complex<T>* pData, int length, T? alpha = null)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Kbd<T>(Complex<T>[] data, int offset, int length, T? alpha = null)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    /// <param name="length"></param>
    /// <param name="alpha">The default value is 4</param>
    public static unsafe void Kbd<T>(Complex<T>* pData, int length, T? alpha = null)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        alpha ??= T.CreateTruncating(4);
        //x var window = new float[length ];
    ...
    public static void Bartlett_Hann<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static unsafe void Bartlett_Hann<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T factor = T.CreateTruncating(1.0 / (length - 1));
        T zero_point_five = T.CreateTruncating(0.5);
    ...
    public static void Lanczos<T>(Complex<T>[] data, int offset, int length)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T factor = T.CreateTruncating(2.0 / (length - 1));
    ...
    public static unsafe void Lanczos<T>(Complex<T>* pData, int length)
        where T : unmanaged, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T factor = T.CreateTruncating(2.0 / (length - 1));
        for (int i = 0; i < length; i++)
    ...
    public static void PowerOfSine<T>(Complex<T>[] data, int offset, int length, T? alpha = null)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    /// <param name="length"></param>
    /// <param name="alpha">The default value is 1.5</param>
    public static unsafe void PowerOfSine<T>(Complex<T>* pData, int length, T? alpha = null)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        alpha ??= T.CreateTruncating(1.5);
        T factor = T.CreateChecked(ConstantsFp32.PI / length);
    ...
    public static void Flattop<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static unsafe void Flattop<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T factor = Constants<T>.Two_Pi / T.CreateTruncating(length - 1);
        T m0_216 = T.CreateChecked(0.216);
    ...
    /// <param name="pData"></param>
    /// <param name="length"></param>
    public static unsafe void Blackman_Harris<T>(Complex<T>* pData, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
    ...
    public static void Blackman_Harris<T>(Complex<T>[] data, int offset, int length)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        T const_0p35875 = T.CreateChecked(0.35875);
        T const_0p48829 = T.CreateChecked(0.48829);
    ...
    public static void Liftering<T>(Complex<T>[] data, int offset, int length, int l = 22)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        if (l <= 0)
        {
    ...
    public static unsafe void Liftering<T>(Complex<T>* pData, int length, int l = 22)
        where T : struct, INumberBase<T>, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        if (l <= 0)
        {
