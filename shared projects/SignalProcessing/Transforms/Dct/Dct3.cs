...
namespace Vorcyc.Mathematics.SignalProcessing.Transforms
{
    ...
    public class Dct3 : IDct
    {
        ...
        public Dct3(int dctSize)
        {
            ...
            var m = ConstantsFp32.PI / (dctSize << 1);
            ...
            for (var k = 0; k < dctSize; k++)
            {
                ...
                {
                    _dctMtx[k][n] = 2 * MathF.Cos(((k << 1) + 1) * n * m);
                }
            }
            ...
            for (var k = 0; k < dctSize; k++)
            {
                ...
                {
                    _dctMtxInv[k][n] = 2 * MathF.Cos(((n << 1) + 1) * k * m);
                }
            }
        }
        ...
        {
            var norm0 = (1 / MathF.Sqrt(_dctSize));
            var norm = MathF.Sqrt(0.5f / _dctSize);
