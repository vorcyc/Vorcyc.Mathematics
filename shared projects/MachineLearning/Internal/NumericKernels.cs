...
/// <summary>
/// Vectorized kernels for the float/double hot path; other <typeparamref name="T"/> falls back to a scalar loop.
/// </summary>
internal static class NumericKernels
{
        ...
        where T : struct, IFloatingPointIeee754<T>
    {
        ...
        if (cols != b.GetLength(1))
            throw new ArgumentException("The matrix column counts do not match.");
