...
internal static class LinearRegession
{
    ...
    internal static void TEST_Half()
    {
        ...
        var result_normal = CurveFitter<Half>.Linear(xData, yData, ComputingContext.Normal);
        ...
        var result_simd = CurveFitter<Half>.Linear(xData, yData, ComputingContext.Simd);
        ...
        //var result_parallel = Fit<float>.Linear(xData, yData, ComputingContext.Parallel);
