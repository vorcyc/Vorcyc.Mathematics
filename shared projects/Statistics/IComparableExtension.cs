...
public static partial class IComparableExtension
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T CompareMax<T>(this T[] values, int start, int length)
        where T : IComparable, IComparable<T>
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T CompareMin<T>(this T[] values)
        where T : IComparable, IComparable<T>
    {
        T result = values[0];
        for (int i = 1; i < values.Length; i++)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T CompareMin<T>(this T[] values, int start, int length)
        where T : IComparable, IComparable<T>
    {
        T result = values[start];
        for (int i = start; i < start + length; i++)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (T max, T min) CompareMaxMin<T>(this T[] values, int start, int length)
        where T : IComparable, IComparable<T>
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMax<T>(T[] values)
        where T : IComparable, IComparable<T>
    {
        T result = values[0];
        int resultIndex = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMax<T>(T[] values, int start, int length)
        where T : IComparable, IComparable<T>
    {
        T result = values[start];
        int resultIndex = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMax<T>(Span<T> span)
        where T : IComparable, IComparable<T>
    {
        T result = span[0];
        int resultIndex = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMin<T>(T[] values)
        where T : IComparable, IComparable<T>
    {
        T result = values[0];
        int resultIndex = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMin<T>(T[] values, int start, int length)
        where T : IComparable, IComparable<T>
    {
        T result = values[start];
        int resultIndex = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (int index, T value) LocateMin<T>(Span<T> span)
        where T : IComparable, IComparable<T>
    {
        T result = span[0];
        int resultIndex = 0;
